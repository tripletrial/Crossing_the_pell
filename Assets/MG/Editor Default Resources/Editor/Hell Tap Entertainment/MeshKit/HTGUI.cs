	...
	// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		...
		public static void SepLine( GUIStyle guiStyle = null, bool addSpaceAtEnd = true ){
			...
			if( guiStyle == null ){
				...
				// On Linux, the sep lines don't show for some reason, so we use a new approach
	...
	// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		...
		public static string TextField( Texture2D icon, string label, string defaultString ) { 
			...
			EditorGUILayout.BeginHorizontal();
				...
				GUILayout.Label(label, GUILayout.MinWidth(defaultMinSizeX), GUILayout.MaxWidth(defaultMaxSizeX), GUILayout.MaxHeight(defaultMaxSizeY));
		...
		public static System.Enum EnumField( Texture2D icon, string label, System.Enum defaultEnum ) { 
			...
			EditorGUILayout.BeginHorizontal();
				GUILayout.Label(icon, GUILayout.MaxWidth(20), GUILayout.MaxHeight(20) );
				if(label!=string.Empty){GUILayout.Label(label, GUILayout.MinWidth(defaultMinSizeX), GUILayout.MaxWidth(defaultMaxSizeX), GUILayout.MaxHeight(defaultMaxSizeY));}
