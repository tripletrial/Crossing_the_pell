...
namespace Gadd420
{
    ...
    public class RB_Controller : MonoBehaviour
    {
        ...
        public bool useEngineBraking = true;
        public float engineBrakingDrag = 0.25f;
        ...
        void Update()
        {
            ...
            if (isGrounded && inputs.VInput == 0 && useEngineBraking)
            {
                rb.drag = engineBrakingDrag;
            }
            else
            {
                rb.drag = ogDrag;
